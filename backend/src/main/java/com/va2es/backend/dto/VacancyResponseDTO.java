...
public class VacancyResponseDTO {
    ...
    public Long representanteId; // ---> CAMPO ESSENCIAL <---
    ...
    public VacancyResponseDTO(Long id, String titulo, String descricao, String requisitos,
                              ...
                              Long idDaEmpresa, String nomeDaEmpresa, Long representanteId, // ---> PARÂMETRO ESSENCIAL <---
                              LocalDate dataPublicacao, LocalDate dataTermino) {
        this.id = id;
        this.titulo = titulo;
        ...
        this.representanteId = representanteId; // ---> ATRIBUIÇÃO ESSENCIAL <---
